...
public class CacheObjectUisngThreadTest {



        public static void main(String[] args) throws InterruptedException {

            CacheObjectUisngThreadTest crunchifyCache = new CacheObjectUisngThreadTest();
        ...
        private void crunchifyTestAddRemoveObjects() {
            ...
            // maxItems = 6
            CacheUsingObjectAndThread<String, String> cache = new CacheUsingObjectAndThread<>(200, 500, 6);
        ...
        private void crunchifyTestExpiredCacheObjects() throws InterruptedException {
            ...
            // maxItems = 10
           CacheUsingObjectAndThread<String, String> cache = new CacheUsingObjectAndThread<>(1, 1, 10);
        ...
        private void crunchifyTestObjectsCleanupTime() throws InterruptedException {
           ...
           CacheUsingObjectAndThread<String, String> cache = new CacheUsingObjectAndThread<>(100, 100, 500000);
            ...
            System.out.println("Cleanup times for " + size + " objects are " + finish + " s" + "and the cleaned up size  is..."+ cache.size());
